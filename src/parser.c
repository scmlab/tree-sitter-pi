...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [76] = {.count = 1, .reusable = true}, SHIFT(32),
  [78] = {.count = 1, .reusable = true}, SHIFT(33),
  [80] = {.count = 1, .reusable = true}, SHIFT(34),
  [82] = {.count = 1, .reusable = true}, SHIFT(35),
  [84] = {.count = 1, .reusable = false}, SHIFT(36),
  [86] = {.count = 1, .reusable = true}, SHIFT(37),
  [88] = {.count = 1, .reusable = false}, SHIFT(38),
  [90] = {.count = 1, .reusable = true}, REDUCE(sym_par, 3),
  ...
  [104] = {.count = 1, .reusable = false}, SHIFT(45),
  [106] = {.count = 1, .reusable = true}, SHIFT(46),
  [108] = {.count = 1, .reusable = true}, SHIFT(47),
  [110] = {.count = 1, .reusable = true}, SHIFT(48),
  [112] = {.count = 1, .reusable = true}, SHIFT(49),
  [114] = {.count = 1, .reusable = true}, REDUCE(sym_nu, 5),
  [116] = {.count = 1, .reusable = true}, REDUCE(sym_recv, 5),
  [118] = {.count = 1, .reusable = true}, REDUCE(sym__expr, 3),
  [120] = {.count = 1, .reusable = false}, REDUCE(sym__expr, 3),
  [122] = {.count = 1, .reusable = true}, REDUCE(sym_send, 5),
  [124] = {.count = 1, .reusable = true}, REDUCE(sym_mul, 3),
  [126] = {.count = 1, .reusable = false}, REDUCE(sym_mul, 3),
  [128] = {.count = 1, .reusable = true}, REDUCE(sym_div, 3),
  [130] = {.count = 1, .reusable = false}, REDUCE(sym_div, 3),
  [132] = {.count = 1, .reusable = true}, REDUCE(sym_add, 3),
  [134] = {.count = 1, .reusable = false}, REDUCE(sym_add, 3),
  [136] = {.count = 1, .reusable = true}, REDUCE(sym_sub, 3),
  [138] = {.count = 1, .reusable = false}, REDUCE(sym_sub, 3),
};
