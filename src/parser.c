...
enum {
  ...
  sym_recv = 30,
  sym__simple_recv = 31,
  sym__complex_recv = 32,
  sym__complex_recv_pairs = 33,
  sym_send = 34,
  sym_call = 35,
  sym_pattern = 36,
  sym__expr = 37,
  ...
  sym_process_name = 45,
  sym__name = 46,
  sym_reserved_name = 47,
  sym_name = 48,
  aux_sym_program_repeat1 = 49,
  aux_sym__complex_recv_repeat1 = 50,
};
...
static const char *ts_symbol_names[] = {
  ...
  [sym__complex_recv] = "_complex_recv",
  [sym__complex_recv_pairs] = "_complex_recv_pairs",
  [sym_send] = "send",
  [sym_call] = "call",
  [sym_pattern] = "pattern",
  [sym__expr] = "_expr",
  ...
  [aux_sym__complex_recv_repeat1] = "_complex_recv_repeat1",
};
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [19] = {
    [sym__simple_recv] = STATE(31),
    [sym__complex_recv] = STATE(31),
  ...
  [29] = {
    [sym__complex_recv_pairs] = STATE(42),
  ...
  [42] = {
    [aux_sym__complex_recv_repeat1] = STATE(57),
  ...
  [55] = {
    [sym__complex_recv_pairs] = STATE(66),
    [sym_pattern] = STATE(43),
    [sym__name] = STATE(30),
    [sym_reserved_name] = STATE(30),
    [sym_name] = STATE(30),
  ...
  [57] = {
    [aux_sym__complex_recv_repeat1] = STATE(68),
    [anon_sym_SEMI] = ACTIONS(118),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [132] = {.count = 1, .reusable = true}, REDUCE(sym__complex_recv, 3),
  [134] = {.count = 1, .reusable = true}, SHIFT(67),
  [136] = {.count = 1, .reusable = true}, SHIFT(69),
  [138] = {.count = 1, .reusable = false}, SHIFT(70),
  [140] = {.count = 1, .reusable = true}, REDUCE(sym__simple_recv, 3),
  ...
  [164] = {.count = 1, .reusable = true}, REDUCE(aux_sym__complex_recv_repeat1, 2),
  [166] = {.count = 1, .reusable = true}, REDUCE(sym__complex_recv, 4),
  [168] = {.count = 2, .reusable = true}, REDUCE(aux_sym__complex_recv_repeat1, 2), SHIFT_REPEAT(55),
  [171] = {.count = 1, .reusable = false}, SHIFT(72),
  [173] = {.count = 1, .reusable = true}, SHIFT(73),
  [175] = {.count = 1, .reusable = true}, REDUCE(sym__complex_recv_pairs, 3),
